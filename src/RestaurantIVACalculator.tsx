      ...
      <div className="backdrop-blur-lg rounded-3xl shadow-2xl p-6 w-full max-w-md border bg-cyan-950/40 border-cyan-500/20 animate-fade-in-up animate-duration-300">
        ...
        {hasResults && (
          <div className="space-y-2 animate-fade-in animate-duration-500">
            ...
            {/* Option D: Subtle text link below main card */}
            <button
              onClick={handleShare}
              className="w-full mt-3 flex items-center justify-center gap-2 text-green-400 hover:text-green-300 transition-colors text-sm"
            ...
            {/* Option A: Compact button after split card */}
            <button
              onClick={handleShare}
