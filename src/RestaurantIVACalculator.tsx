      ...
      <div className="backdrop-blur-lg rounded-3xl shadow-2xl p-6 w-full max-w-md border bg-cyan-950/40 border-cyan-500/20 animate-fade-in-up animate-duration-300">
        ...
        {hasResults && (
          <div className="space-y-2 animate-fade-in animate-duration-500">
            ...
            {/* WhatsApp share button - contextual action */}
            {hasResults && (
              <button
                onClick={handleShare}
                className="w-full mt-3 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-green-600/50 bg-green-600/10 hover:bg-green-600/20 text-green-400 hover:text-green-300 text-sm transition-all"
