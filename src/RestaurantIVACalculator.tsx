      ...
      <div className="backdrop-blur-lg rounded-3xl shadow-2xl p-6 w-full max-w-md border bg-cyan-950/40 border-cyan-500/20 animate-fade-in-up animate-duration-300">
        ...
        {hasResults && (
          <div className="space-y-2 animate-fade-in animate-duration-500">
            ...
            <button
              onClick={handleShare}
              className="w-full mt-3 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white font-medium transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
            >
