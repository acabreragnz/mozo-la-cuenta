          ...
          <div className="space-y-2 animate-fade-in animate-duration-500">
            ...
            <div className="mt-4">
              ...
              >
                ...
                {/* WhatsApp button inside accordion */}
                <button
                  onClick={handleShare}
                  className="w-full mt-2 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-green-600 bg-green-600/10 hover:bg-green-600/20 text-green-400 transition-all text-sm font-medium"
