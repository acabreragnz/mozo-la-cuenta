      ...
      <div className="backdrop-blur-lg rounded-3xl shadow-2xl p-6 w-full max-w-md border bg-cyan-950/40 border-cyan-500/20 animate-fade-in-up animate-duration-300">
        ...
        {hasResults && (
          <div className="space-y-2 animate-fade-in animate-duration-500">
            ...
            <div className="rounded-2xl p-4 mt-3 bg-gradient-to-r from-cyan-500 to-sky-500 relative">
              {/* Share icon in corner */}
              <button
                onClick={handleShare}
                className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-lg bg-white/20 hover:bg-white/30 transition-all hover:scale-110 active:scale-95"
